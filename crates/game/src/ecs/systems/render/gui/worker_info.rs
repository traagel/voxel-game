...
use crate::ecs::resources::window_manager::WorkerInfoStateRes;

/// Draw the worker information window
pub fn draw_worker_info_window(state: &mut WorkerInfoStateRes) {
